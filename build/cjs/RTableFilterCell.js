...
var RTableFilterCell = React.createClass({
    ...
    render : function(){
            return (React.createElement("th", {className: "rtable-col rtable-filter"}, React.createElement("input", {type: "text", value: this.state.filter, onChange: this.handleChange})));
          }
    });
